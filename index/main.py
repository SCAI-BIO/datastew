...
if EVAL_AD:
    cdm_ad_gpt = cdm_pd_gpt = MappingTable(MappingSource(AD_CDM_SRC, "Feature", "CURIE"))
    cdm_ad_gpt.add_descriptions(DataDictionarySource(PD_CDM_SRC, "Feature", "Definition"))
    cdm_ad_gpt.compute_embeddings(gpt4)

    cdm_ad_mpnet = cdm_pd_gpt = MappingTable(MappingSource(AD_CDM_SRC, "Feature", "CURIE"))
    cdm_ad_mpnet.add_descriptions(DataDictionarySource(PD_CDM_SRC, "Feature", "Definition"))
    cdm_ad_mpnet.compute_embeddings(mpnet)

    a4_gpt = MappingTable(MappingSource(AD_CDM_SRC, "A4", "CURIE"))
    a4_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/a4.csv", "FLDNAME", "TEXT"))
    a4_gpt.compute_embeddings(gpt4)

    a4_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "A4", "CURIE"))
    a4_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/a4.csv", "FLDNAME", "TEXT"))
    a4_mpnet.compute_embeddings(mpnet)

    abvib_gpt = MappingTable(MappingSource(AD_CDM_SRC, "ABVIB", "CURIE"))
    abvib_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/abvib.csv", "variable_name", "description"))
    abvib_gpt.compute_embeddings(gpt4)

    abvib_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "ABVIB", "CURIE"))
    abvib_mpnet.add_descriptions( DataDictionarySource("resources/dictionaries/ad/abvib.csv", "variable_name", "description"))
    abvib_mpnet.compute_embeddings(mpnet)

    adni_gpt = MappingTable(MappingSource(AD_CDM_SRC, "ADNI", "CURIE"))
    adni_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/ADNIMERGE_DICT_27Nov2023 2.csv", "FLDNAME", "TEXT"))
    adni_gpt.compute_embeddings(gpt4)

    adni_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "ADNI", "CURIE"))
    adni_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/ADNIMERGE_DICT_27Nov2023 2.csv", "FLDNAME", "TEXT"))
    adni_mpnet.compute_embeddings(mpnet)

    aibl_gpt = MappingTable(MappingSource(AD_CDM_SRC, "AIBL", "CURIE"))
    aibl_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/aibl.csv", "Name", "Description"))
    aibl_gpt.compute_embeddings(gpt4)

    aibl_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "AIBL", "CURIE"))
    aibl_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/aibl.csv", "Name", "Description"))
    aibl_mpnet.compute_embeddings(mpnet)

    arwibo_gpt = MappingTable(MappingSource(AD_CDM_SRC, "ARWIBO", "CURIE"))
    arwibo_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/arwibo.csv", "Variable_Name", "Element_description"))
    arwibo_gpt.compute_embeddings(gpt4)

    arwibo_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "ARWIBO", "CURIE"))
    arwibo_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/arwibo.csv", "Variable_Name", "Element_description"))
    ...
    dod_adni_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/dod-adni.csv", "FLDNAME", "TEXT"))
    dod_adni_gpt.compute_embeddings(gpt4)

    dod_adni_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "DOD-ADNI", "CURIE"))
    # TODO most descriptions missing
    dod_adni_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/dod-adni.csv", "FLDNAME", "TEXT"))
    dod_adni_mpnet.compute_embeddings(mpnet)

    edsd_gpt = MappingTable(MappingSource(AD_CDM_SRC, "EDSD", "CURIE"))
    edsd_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/edsd.xlsx", "Variable_Name", "Element_description"))
    edsd_gpt.compute_embeddings(gpt4)

    edsd_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "EDSD", "CURIE"))
    edsd_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/edsd.xlsx", "Variable_Name", "Element_description"))
    edsd_mpnet.compute_embeddings(mpnet)

    emif_gpt = MappingTable(MappingSource(AD_CDM_SRC, "EMIF", "CURIE"))
    emif_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/emif.xlsx", "Variable", "Description"))
    emif_gpt.compute_embeddings(gpt4)

    emif_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "EMIF", "CURIE"))
    emif_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/emif.xlsx", "Variable", "Description"))
    ...
    i_adni_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/i-adni.csv", "acronym", "variable"))
    i_adni_gpt.compute_embeddings(gpt4)

    i_adni_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "I-ADNI", "CURIE"))
    # TODO about half of descriptions missing
    i_adni_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/i-adni.csv", "acronym", "variable"))
    i_adni_mpnet.compute_embeddings(mpnet)

    jadni_gpt = MappingTable(MappingSource(AD_CDM_SRC, "JADNI", "CURIE"))
    jadni_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/jadni.tsv", "FLDNAME", "TEXT"))
    jadni_gpt.compute_embeddings(gpt4)

    jadni_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "JADNI", "CURIE"))
    jadni_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/jadni.tsv", "FLDNAME", "TEXT"))
    jadni_mpnet.compute_embeddings(mpnet)

    pharmacog_gpt = MappingTable(MappingSource(AD_CDM_SRC, "PharmaCog", "CURIE"))
    pharmacog_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/pharmacog.csv", "Variable_Name", "Element_description"))
    pharmacog_gpt.compute_embeddings(gpt4)

    pharmacog_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "PharmaCog", "CURIE"))
    pharmacog_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/pharmacog.csv", "Variable_Name", "Element_description"))
    pharmacog_mpnet.compute_embeddings(mpnet)

    prevent_ad_gpt = MappingTable(MappingSource(AD_CDM_SRC, "PREVENT-AD", "CURIE"))
    prevent_ad_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/prevent-ad.csv", "variable", "description"))
    prevent_ad_gpt.compute_embeddings(gpt4)

    prevent_ad_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "PREVENT-AD", "CURIE"))
    prevent_ad_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/prevent-ad.csv", "variable", "description"))
    prevent_ad_mpnet.compute_embeddings(mpnet)

    vita_gpt = MappingTable(MappingSource(AD_CDM_SRC, "VITA", "CURIE"))
    vita_gpt.add_descriptions(DataDictionarySource("resources/dictionaries/ad/vita.csv", "Variable_Name", "Element_description"))
    vita_gpt.compute_embeddings(gpt4)

    vita_mpnet = MappingTable(MappingSource(AD_CDM_SRC, "VITA", "CURIE"))
    vita_mpnet.add_descriptions(DataDictionarySource("resources/dictionaries/ad/vita.csv", "Variable_Name", "Element_description"))
    vita_mpnet.compute_embeddings(mpnet)

    wmh_ad = MappingTable(MappingSource(AD_CDM_SRC, "VITA", "CURIE"))

    ad_datasets_gpt = [a4_gpt, abvib_gpt, adni_gpt, aibl_gpt, arwibo_gpt, dod_adni_gpt, edsd_gpt, emif_gpt, i_adni_gpt, jadni_gpt,
    ...
    ad_datasets_mpnet = [a4_mpnet, abvib_mpnet, adni_mpnet, aibl_mpnet, arwibo_mpnet, dod_adni_mpnet, edsd_mpnet, emif_mpnet,
                         i_adni_mpnet, jadni_mpnet, pharmacog_mpnet, prevent_ad_mpnet, vita_mpnet, cdm_ad_mpnet]
