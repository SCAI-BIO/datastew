...
class Test(TestCase):
    ...
    def test_repository(self):
        ...
        sentence_embedder1 = SentenceEmbedder(model_name1)
        sentence_embedder2 = SentenceEmbedder(model_name2)
        ...
        mapping1 = Mapping(concept1, text1, embedding_model1.get_embedding(text1), sentence_embedder1)

        text2 = "Hypertension (disorder)"
        concept2 = Concept(terminology1, text2, "Concept ID: 73211009")
        mapping2 = Mapping(concept2, text2, embedding_model2.get_embedding(text2), sentence_embedder2)

        text3 = "Asthma"
        concept3 = Concept(terminology1, text3, "Concept ID: 195967001")
        mapping3 = Mapping(concept3, text3, embedding_model1.get_embedding(text3), sentence_embedder1)

        text4 = "Heart attack"
        concept4 = Concept(terminology1, text4, "Concept ID: 22298006")
        mapping4 = Mapping(concept4, text4, embedding_model2.get_embedding(text4), sentence_embedder2)

        text5 = "Common cold"
        concept5 = Concept(terminology2, text5, "Concept ID: 13260007")
        mapping5 = Mapping(concept5, text5, embedding_model1.get_embedding(text5), sentence_embedder1)

        text6 = "Stroke"
        concept6 = Concept(terminology2, text6, "Concept ID: 422504002")
        mapping6 = Mapping(concept6, text6, embedding_model2.get_embedding(text6), sentence_embedder2)

        text7 = "Migraine"
        concept7 = Concept(terminology2, text7, "Concept ID: 386098009")
        mapping7 = Mapping(concept7, text7, embedding_model1.get_embedding(text7), sentence_embedder1)

        text8 = "Influenza"
        concept8 = Concept(terminology2, text8, "Concept ID: 57386000")
        mapping8 = Mapping(concept8, text8, embedding_model2.get_embedding(text8), sentence_embedder2)

        text9 = "Osteoarthritis"
        concept9 = Concept(terminology2, text9, "Concept ID: 399206004")
        mapping9 = Mapping(concept9, text9, embedding_model1.get_embedding(text9), sentence_embedder1)

        text10 = "The flu"

        repository.store_all([
            sentence_embedder1, sentence_embedder2, terminology1, terminology2, concept1, mapping1,
            concept2, mapping2, concept3, mapping3, concept4, mapping4, concept5, mapping5, concept6,
            mapping6, concept7, mapping7, concept8, mapping8, concept9, mapping9
        ])
        ...
        embedder_names = [embedder.name for embedder in sentence_embedders]
        self.assertEqual(len(sentence_embedders), 2)
        self.assertIn(model_name1, embedder_names)
        self.assertIn(model_name2, embedder_names)
        ...
        self.assertEqual(closest_mappings[0].sentence_embedder.name, model_name1)
        ...
        self.assertEqual(closest_mappings_with_similarities[0][0].sentence_embedder.name, model_name1)
        ...
        self.assertEqual(terminology_and_model_specific_closest_mappings[0][0].sentence_embedder.name, model_name1)
        self.assertEqual(closest_mappings_with_similarities[0][1], 0.6747197)
        ...
        repository.store_all([
            sentence_embedder1, sentence_embedder2, terminology1, terminology2, concept1,
            mapping1, concept2, mapping2, concept3, mapping3, concept4, mapping4, concept5, 
            mapping5, concept6, mapping6, concept7, mapping7, concept8, mapping8, concept9, mapping9
        ])
