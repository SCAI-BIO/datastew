...
class Test(TestCase):
    ...
    def test_match_closest_descriptions_embeddings(self):
        mapping_table1 = _MappingTable(self.mapping_source, self.data_dictionary_source)
        mapping_table2 = _MappingTable(self.mapping_source, self.data_dictionary_source)
